...
)  # создание поля приспособленности индивида
creator.create(
    "Individual", list, fitness=creator.FitnessMax
)  # создание класса индивида(поскольку наследуемся от списка, то индивид - это список генов)
...
)  # функция, возвращающая случайно 0 или 1
